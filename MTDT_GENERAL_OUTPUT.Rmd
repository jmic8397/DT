...
# show(results)
# 
# loginc = is.na(experiments(melanomaAssaysNorm)[1])
# 
# melanomaAssaysNorm
# rownames(colData(completeCases)) = melanomaAssaysNorm[,complete.cases(melanomaAssaysNorm[,,4]),]
# 
# complete.cases(melanomaAssaysNorm)
# colData(melanomaAssaysNorm[,,])
# 
# complete.cases(melanomaAssaysNorm[,,1])
# 
#   NALIST = (rownames(colData(melanomaAssaysNorm[complete.cases(melanomaAssaysNorm[,,4]),,])) %in% rownames(colData(melanomaAssaysNorm)))
...
# remove = list("132", "108")
# people = rownames(colData(melanomaAssaysNorm))
# retainedpp = !(people %in%  remove)
# people
# peopleNew = melanomaAssaysNorm[,retainedpp,]
# rownames(colData(peopleNew))
...
Original - Andy Wang- # Multi-tier decision tree
